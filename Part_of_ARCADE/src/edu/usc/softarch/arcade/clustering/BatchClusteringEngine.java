...
//            builder.build(builderArgs);
            builder.buildFromRSF(builderArgs);
            ...
            System.out.println(ClusteringAlgoRunner.getFastClusters().size());
            // have to set some Config settings before executing the runner
            int numClusters = (int) ((double) ClusteringAlgoRunner.getFastClusters()
