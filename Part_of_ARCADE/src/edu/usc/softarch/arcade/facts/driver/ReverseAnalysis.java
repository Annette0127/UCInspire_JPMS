...
public class ReverseAnalysis {
    ...
    private double computePkgClusterSim(String clusterName, Map<String, Map<String, Entity>> clusterNameToEntities, HashMap<String, Integer> pkgSizeMap) {
        ...
        //System.out.println(pkgCountMap.entrySet());
        ...
        int pkgSize = 0;
//        System.out.println("=====" + pkgSizeMap.size() + "=====");
//        System.out.println("=======" + maxPkgName + "=======" + pkgSizeMap.get(maxPkgName) + "=======");
    ...
    public static void main(String[] args) {
        ...
        //RsfReader.loadRsfDataFromFile("hadoop-0.19-edu.usc.softarch.arcade.odem-facts.rsf");
