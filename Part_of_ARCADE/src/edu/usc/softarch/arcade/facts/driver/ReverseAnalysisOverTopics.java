...
//			out = new BufferedWriter(new FileWriter("outfile.csv"));
            out = new BufferedWriter(new FileWriter("/Users/hyr/Documents/Projects/UCInspire/project-materials/Ballerina-Lang_Project/out/criteria_indicator/arc/preview5-outfile.csv"));
...
//		RsfReader.loadRsfDataFromFile("archstudio4_deps (1).rsf");
        RsfReader.loadRsfDataFromFile("/Users/hyr/Documents/Projects/UCInspire/project-materials/Ballerina-Lang_Project/dep/ballerina-lang-2.0.0-Preview5_deps.rsf");
        List<List<String>> depFacts = RsfReader.unfilteredFacts;

//		RsfReader
//				.loadRsfDataFromFile("archstudio4_clean_ground_truth_recovery.rsf");
//		JUnit-Project-No-Test/output/arc/junit-5.4.2_108_topics_104_arc_clusters.rsf
        RsfReader
                .loadRsfDataFromFile("/Users/hyr/Documents/Projects/UCInspire/project-materials/Ballerina-Lang_Project/ground-truth/preview5_ground-truth_clusters.rsf");
...
//							"/home/joshua/Documents/Software Engineering Research/subject_systems/archstudio4/doc-topics-filelist.txt"));
            BufferedReader br = new BufferedReader(
                    new FileReader(
                            "/Users/hyr/Documents/Projects/UCInspire/project-materials/Ballerina-Lang_Project/out/criteria_indicator/arc/doc-topics-filelist.txt"));
            String line = null;
    ...
    private static double computeJSDivergence(String clusterName,
        ...
        Object[] entities = nameToEntity.values().toArray();
        double sum = 0;
        HashSet<Entity> anonymous = new HashSet<>();
        int n = 0; // number of simMeasure values
        for (int i = 0; i < entities.length; i++) {
            for (int j = i + 1; j < entities.length; j++) {
                ...
                // included in the computation
                {
                    double simMeasure = SimCalcUtil.getJSDivergence(entity1,
                            entity2);
//                    if (simMeasure == 0) System.out.println("sim is 0: " + entity1.name + "  " + entity2.name);
                    ...
                    if (entity1.docTopicItem == null) anonymous.add(entity1);
                    if (entity2.docTopicItem == null) anonymous.add(entity2);
...
//                System.out.println("2222222size:" + anonymous.size());
//            else if (entities.length == 3)
//                System.out.println("3333333size:" + anonymous.size());
//            else if (entities.length == 4)
//                System.out.println("4444444size:" + anonymous.size());
//            else if (entities.length == 5)
//                System.out.println("5555555size:" + anonymous.size());
//        }
//        System.out.println("Sum and n for JSDivergence are " + sum + " " + n + " " + (sum / n));
        double average = (sum / n);
        return average;
