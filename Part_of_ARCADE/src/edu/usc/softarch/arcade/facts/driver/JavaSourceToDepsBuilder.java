...
//        (new JavaSourceToDepsBuilder()).build(args);
        // hyr
        (new JavaSourceToDepsBuilder()).buildFromRSF(args);
    }
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
    //hyr build from dependency ".rsf" file
    public void buildFromRSF(String[] args) {
        try {
            PropertyConfigurator.configure(Config.getLoggingConfigFilename());
            ...
            BufferedReader in = new BufferedReader(new FileReader(depsRsfFilename));
            edges = new LinkedHashSet<Pair<String, String>>();
            String str;

            while ((str = in.readLine()) != null) {
                String[] arr = str.split("[\s]+");
                Pair<String, String> edge = new ImmutablePair<String, String>(arr[1], arr[2]);
                edges.add(edge);
            }
